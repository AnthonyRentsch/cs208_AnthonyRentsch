...
Q(x_i) = \left\{
        \begin{array}{ll}
            x_i & w.p. \frac{e^{\epsilon}}{e^{\epsilon}+1} \\
            1-x_i & w.p. \frac{1}{e^{\epsilon}+1}
        \end{array}
    \right.
$$
...
\begin{aligned}
  ...
  &= x_i\frac{e^{\epsilon}-1}{e^{\epsilon}+1} + \frac{n}{e^{\epsilon}-1} \\
\end{aligned} \\
$$
...
\begin{aligned}
  ...
  \\
  E[c*\hat{p_j}_{numerator} + d] &= \frac{e^{\epsilon}+1}{e^{\epsilon}-1}\left[x_i\frac{e^{\epsilon}-1}{e^{\epsilon}+1} + \frac{n}{e^{\epsilon}-1}\right] - \frac{n}{e^{\epsilon}-1} \\
  &= x_i + \frac{n}{e^{\epsilon}-1} - \frac{n}{e^{\epsilon}-1} \\
  &= x_i
\end{aligned}
$$
