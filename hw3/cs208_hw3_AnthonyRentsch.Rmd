...
- clip data to small positive value (1) and log it as a pre-process
- income value i use from here on out is now the $log(clip(income))$
- print out main results in a table

```{r, echo=FALSE, message=FALSE}
require(knitr)
options(scipen=999)
q3_results <- read.csv("q3_results.csv")
knitr::kable(q3_results)
```
