...
-$\sqrt{d}/n$?
-Dwork test stat --> rscaled to -1, 1
-using only derived attributes now and expected column means of 0.5 (rescaled to 0)
-what do i see
-maybe make a plot for what i think are right values but look bad versus plots that look good but use values that I'm not sure are right (accuracy around 92% - US citizenship rate in population)
